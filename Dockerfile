...
ENV AZURE_STORAGE_CONNECTION_STRING = ${secrets.AZURE_STORAGE_CONNECTION_STRING}
ARG AZURE_STORAGE_CONNECTION_STRING = ${secrets.AZURE_STORAGE_CONNECTION_STRING}
RUN AZURE_STORAGE_CONNECTION_STRING=$AZURE_STORAGE_CONNECTION_STRING yarn build
